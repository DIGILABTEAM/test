...
window.updatePreview = function(url) {
  ...
  document.getElementById('fg').style.width = '600px'
  document.getElementById('fg').style.height = '600px'
};
    ...
    reader.onload = function (e) {
      ...
      image.onload = function() {
        ...
        if(width >= 600 && height >= 600)
          ...
          alert("Image should be atleast have 600px width and 600px height");
      };
